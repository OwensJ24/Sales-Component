...
The string key will represent the name and unique identifer of the item, and the
SalesData class will represent the data corresponding to the item in the map.
