...
Transitioned over to making a new class to contain sales data. Added a kernel method for size; Changed over to LocalDate from int.  Added a removeAnyTransaction() method to kernel for traversal.
